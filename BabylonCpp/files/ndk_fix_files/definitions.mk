...
# -----------------------------------------------------------------------------
# Template  : ev-compile-ll-source
# Arguments : 1: single LLVM IR source file name (relative to LOCAL_PATH)
#             2: target object file (without path)
# Returns   : None
# Usage     : $(eval $(call ev-compile-ll-source,<srcfile>,<objfile>)
# Rationale : Internal template evaluated by compile-ll-source
# -----------------------------------------------------------------------------
define  ev-compile-ll-source
_SRC:=$$(call local-source-file-path,$(1))
_OBJ:=$$(LOCAL_OBJS_DIR:%/=%)/$(2)
...
# -----------------------------------------------------------------------------
# Function  : compile-ll-source
# Arguments : 1: single LLVM IR source file name (relative to LOCAL_PATH)
#             2: object file
# Returns   : None
# Usage     : $(call compile-ll-source,<srcfile>,<objfile>)
