...
var computeBoxExtents = (Vector3 axis, BoundingBox box) => {
...
;
var extentsOverlap = (float min0, float max0, float min1, float max1) => {
}
;
var axisOverlap = (Vector3 axis, BoundingBox box0, BoundingBox box1) => {
