...
private dynamic _offsetsCache=new dynamic();
private dynamic _highLimitsCache=new dynamic();
private dynamic _stopped=false;
...
public Animation(string name, string targetProperty, float framePerSecond, float dataType, float loopMode) {
...
this._offsetsCache=new dynamic();
this._highLimitsCache=new dynamic();
}
private virtual void _interpolate(float currentFrame, float repeatCount, float loopMode, dynamic offsetValue, dynamic highLimitValue) {
...
private static dynamic _ANIMATIONTYPE_FLOAT=0;
private static dynamic _ANIMATIONTYPE_VECTOR3=1;
private static dynamic _ANIMATIONTYPE_QUATERNION=2;
private static dynamic _ANIMATIONTYPE_MATRIX=3;
private static dynamic _ANIMATIONTYPE_COLOR3=4;
private static dynamic _ANIMATIONLOOPMODE_RELATIVE=0;
private static dynamic _ANIMATIONLOOPMODE_CYCLE=1;
private static dynamic _ANIMATIONLOOPMODE_CONSTANT=2;
}
}
