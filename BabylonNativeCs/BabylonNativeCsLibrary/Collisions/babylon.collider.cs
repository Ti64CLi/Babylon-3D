...
public dynamic radius=new BABYLON.Vector3(1, 1, 1);
public dynamic retry=0;
public Vector3 velocity;
public Vector3 basePoint;
public float epsilon;
public bool collisionFound;
public float velocityWorldLength;
public dynamic basePointWorld=BABYLON.Vector3.Zero();
public dynamic velocityWorld=BABYLON.Vector3.Zero();
public dynamic normalizedVelocity=BABYLON.Vector3.Zero();
public Vector3 initialVelocity;
public Vector3 initialPosition;
public float nearestDistance;
public Vector3 intersectionPoint;
public AbstractMesh collidedMesh;
private dynamic _collisionPoint=BABYLON.Vector3.Zero();
private dynamic _planeIntersectionPoint=BABYLON.Vector3.Zero();
private dynamic _tempVector=BABYLON.Vector3.Zero();
private dynamic _tempVector2=BABYLON.Vector3.Zero();
private dynamic _tempVector3=BABYLON.Vector3.Zero();
private dynamic _tempVector4=BABYLON.Vector3.Zero();
private dynamic _edge=BABYLON.Vector3.Zero();
private dynamic _baseToVertex=BABYLON.Vector3.Zero();
private dynamic _destinationPoint=BABYLON.Vector3.Zero();
private dynamic _slidePlaneNormal=BABYLON.Vector3.Zero();
private dynamic _displacementVector=BABYLON.Vector3.Zero();
...
public virtual void _collide(dynamic subMesh, Vector3[] pts, float[] indices, float indexStart, float indexEnd, float decal) {
