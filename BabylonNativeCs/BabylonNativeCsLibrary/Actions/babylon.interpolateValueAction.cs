...
public InterpolateValueAction(object triggerOptions, object target, string propertyPath, object value, float duration, Condition condition, bool stopOtherAnimations) {
...
scene.beginDirectAnimation(this._target, new Array<object>(), 0, 100);
}
}
}
