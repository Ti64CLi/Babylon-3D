...
namespace BABYLON {
    public partial class SpriteManager {
        ...
        private Array < object > _vertexDeclaration = new Array < object > (3, 4, 4, 4);
        private double _vertexStrideSize = 15 * 4;
        ...
        public SpriteManager(string name, string imgUrl, double capacity, double cellSize, Scene scene, double epsilon = 0.0) {
            ...
            this._vertexDeclaration = new Array < object > (3, 4, 4, 4);
            ...
            this._effectBase = this._scene.getEngine().createEffect("sprites", new Array < object > ("position", "options", "cellInfo", "color"), new Array < object > ("view", "projection", "textureInfos", "alphaTest"), new Array < object > ("diffuseSampler"), "");
            this._effectFog = this._scene.getEngine().createEffect("sprites", new Array < object > ("position", "options", "cellInfo", "color"), new Array < object > ("view", "projection", "textureInfos", "alphaTest", "vFogInfos", "vFogColor"), new Array < object > ("diffuseSampler"), "#define FOG");
        }
        private void _appendSpriteVertex(double index, Sprite sprite, double offsetX, double offsetY, double rowSize) {
