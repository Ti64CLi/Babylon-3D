...
namespace BABYLON {
    public partial class PostProcessRenderPass {
        ...
        private Array < Mesh > _renderList;
        private RenderTargetTexture _renderTexture;
        private Scene _scene;
        private double _refCount = 0;
        public string _name;
        public PostProcessRenderPass(Scene scene, string name, double size, Array < Mesh > renderList, System.Action beforeRender, System.Action afterRender) {
            this._name = name;
        ...
        public virtual void setRenderList(Array < Mesh > renderList) {
