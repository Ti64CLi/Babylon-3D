...
namespace BABYLON {
    public partial class FxaaPostProcess: PostProcess {
        ...
        public FxaaPostProcess(string name, double ratio, Camera camera, double samplingMode = 0.0, Engine engine = null, bool reusable = false): base(name, "fxaa", new Array < object > ("texelSize"), null, ratio, camera, samplingMode, engine, reusable) {
            this.onSizeChanged = () => {
