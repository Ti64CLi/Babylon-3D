// --------------------------------------------------------------------------------------------------------------------
// <copyright file="babylon.oculusDistortionCorrectionPostProcess.cs" company="">
//   
// </copyright>
// <summary>
//   
...
namespace BABYLON
{
    ...
    public partial class OculusDistortionCorrectionPostProcess : PostProcess
    {
        ...
        public OculusDistortionCorrectionPostProcess(string name, Camera camera, bool isRightEye, object cameraSettings)
            : base(name, "oculusDistortionCorrection", new Array<object>("LensCenter", "Scale", "ScaleIn", "HmdWarpParam"), null, cameraSettings.PostProcessScaleFactor, camera, BABYLON.Texture.BILINEAR_SAMPLINGMODE, null, null)
        {
