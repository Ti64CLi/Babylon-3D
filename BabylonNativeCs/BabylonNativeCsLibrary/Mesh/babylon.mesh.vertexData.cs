...
namespace BABYLON {
    public partial interface IGetSetVerticesData {
        ...
        void setIndices(Array < double > indices);
    }
    public partial class VertexData {
        ...
        public virtual void set(Array < double > data, string kind) {
            switch (kind) {
        ...
        public static VertexData CreateCylinder(double height, double diameterTop, double diameterBottom, double tessellation, double subdivisions = 1) {
        ...
        public static void CreateTorus(object diameter, object thickness, object tessellation) {
            var indices = new Array < object > ();
            var positions = new Array < object > ();
            var normals = new Array < object > ();
            var uvs = new Array < object > ();
        ...
        public static VertexData CreateGroundFromHeightMap(double width, double height, double subdivisions, double minHeight, double maxHeight, Uint8Array buffer, double bufferWidth, double bufferHeight) {
            var indices = new Array < object > ();
            var positions = new Array < object > ();
            var normals = new Array < object > ();
            var uvs = new Array < object > ();
