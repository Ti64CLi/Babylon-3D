...
namespace BABYLON.Internals {
    public partial class TGATools {
        private
        const double _TYPE_NO_DATA = 0;
        private
        const double _TYPE_INDEXED = 1;
        private
        const double _TYPE_RGB = 2;
        private
        const double _TYPE_GREY = 3;
        private
        const double _TYPE_RLE_INDEXED = 9;
        private
        const double _TYPE_RLE_RGB = 10;
        private
        const double _TYPE_RLE_GREY = 11;
        private
        const double _ORIGIN_MASK = 0x30;
        private
        const double _ORIGIN_SHIFT = 0x04;
        private
        const double _ORIGIN_BL = 0x00;
        private
        const double _ORIGIN_BR = 0x01;
        private
        const double _ORIGIN_UL = 0x02;
        private
        const double _ORIGIN_UR = 0x03;
        public static object GetTGAHeader(Uint8Array data) {
            var offset = 0;
            var header = new {};
            return header;
        }
