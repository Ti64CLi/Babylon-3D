...
namespace BABYLON {
    public partial class ParticleSystem: IDisposable {
        ...
        private Array < object > _vertexDeclaration = new Array < object > (3, 4, 4);
        private double _vertexStrideSize = 11 * 4;
        ...
        public virtual void _appendParticleVertex(double index, Particle particle, double offsetX, double offsetY) {
            var offset = index * 11;
        ...
        private Effect _getEffect() {
            ...
            if (this._cachedDefines != join) {
                ...
                this._effect = this._scene.getEngine().createEffect("particles", new Array < object > ("position", "color", "options"), new Array < object > ("invView", "view", "projection", "vClipPlane", "textureMask"), new Array < object > ("diffuseSampler"), join);
            }
            return this._effect;
        }
        ...
        public virtual ParticleSystem clone(string name, object newEmitter) {
            ...
            BABYLON.Tools.DeepCopy(this, result, new Array < object > ("particles"), new Array < object > ("_vertexDeclaration", "_vertexStrideSize"));
            if (newEmitter == null) {
