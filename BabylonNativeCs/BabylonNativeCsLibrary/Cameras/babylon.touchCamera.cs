...
private dynamic _pointerPressed=new Array<object>();
...
BABYLON.Tools.RegisterTopRootEvents(new Array<object>());
}
...
BABYLON.Tools.UnregisterTopRootEvents(new Array<object>());
