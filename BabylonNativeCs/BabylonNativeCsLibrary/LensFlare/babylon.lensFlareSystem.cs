...
public dynamic lensFlares=new Array();
public dynamic borderLimit=300;
public Func<Mesh, bool> meshesSelectionPredicate;
...
this.meshesSelectionPredicate=(dynamic m) => {
}
;
...
this._effect=this._scene.getEngine().createEffect("lensFlar", new Array<object>(), new Array<object>(), new Array<object>(), "\"");
}
