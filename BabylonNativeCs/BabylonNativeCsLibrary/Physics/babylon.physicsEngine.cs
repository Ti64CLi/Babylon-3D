...
namespace BABYLON {
    public partial interface IPhysicsEnginePlugin {
        ...
        object registerMeshesAsCompound(Array < PhysicsCompoundBodyPart > parts, PhysicsBodyCreationOptions options);
    ...
    public partial class PhysicsEngine {
        ...
        public virtual object _registerMeshesAsCompound(Array < PhysicsCompoundBodyPart > parts, PhysicsBodyCreationOptions options) {
