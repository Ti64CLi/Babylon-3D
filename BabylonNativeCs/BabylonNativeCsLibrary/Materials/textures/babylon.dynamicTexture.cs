...
public DynamicTexture(string name, object options, Scene scene, bool generateMipMaps, float samplingMode) {
...
public virtual void update(bool invertY) {
this.getScene().getEngine().updateDynamicTexture(this._texture, this._canvas, (invertY==undefined) ? true : invertY);
}
public virtual void drawText(string text, float x, float y, string font, string color, string clearColor, bool invertY) {
