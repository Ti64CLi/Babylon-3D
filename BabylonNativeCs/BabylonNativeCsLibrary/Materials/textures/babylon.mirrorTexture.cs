...
public dynamic mirrorPlane=new BABYLON.Plane(0, 1, 0, 1);
private dynamic _transformMatrix=BABYLON.Matrix.Zero();
private dynamic _mirrorMatrix=BABYLON.Matrix.Zero();
private Matrix _savedViewMatrix;
public MirrorTexture(string name, float size, Scene scene, bool generateMipMaps) {
