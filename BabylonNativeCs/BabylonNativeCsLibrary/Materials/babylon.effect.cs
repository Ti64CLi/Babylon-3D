...
private string[] _uniformsNames;
private string[] _samplers;
private dynamic _isReady=false;
private dynamic _compilationException="\"";
private string[] _attributesNames;
private float[] _attributes;
private WebGLUniformLocation[] _uniforms;
public string _key;
private WebGLProgram _program;
private dynamic _valueCache=new Array<object>();
public Effect(object baseName, string[] attributesNames, string[] uniformsNames, string[] samplers, dynamic engine, string defines, string[] optionalDefines, Func<Effect, object> onCompiled, Func<Effect, string, object> onException) {
this._engine=engine;
this.name=baseName;
...
this._loadVertexShader(vertexSource, (dynamic vertexCode) => {
this._loadFragmentShader(fragmentSource, (dynamic fragmentCode) => {
...
;
var loadCubeTexture = (dynamic rootUrl, dynamic parsedTexture, dynamic scene) => {
...
;
var loadTexture = (dynamic rootUrl, dynamic parsedTexture, dynamic scene) => {
...
;
var parseSkeleton = (dynamic parsedSkeleton, dynamic scene) => {
...
;
var parseMaterial = (dynamic parsedMaterial, dynamic scene, dynamic rootUrl) => {
var material;
...
;
var parseMaterialById = (dynamic id, dynamic parsedData, dynamic scene, dynamic rootUrl) => {
...
;
var parseMultiMaterial = (dynamic parsedMultiMaterial, dynamic scene) => {
...
;
var parseLensFlareSystem = (dynamic parsedLensFlareSystem, dynamic scene, dynamic rootUrl) => {
...
;
var parseParticleSystem = (dynamic parsedParticleSystem, dynamic scene, dynamic rootUrl) => {
...
;
var parseShadowGenerator = (dynamic parsedShadowGenerator, dynamic scene) => {
...
;
var parseAnimation = (dynamic parsedAnimation) => {
...
keys.push(new dynamic());
}
animation.setKeys(keys);
return animation;
}
;
var parseLight = (dynamic parsedLight, dynamic scene) => {
var light;
...
;
var parseCamera = (dynamic parsedCamera, dynamic scene) => {
...
;
var parseGeometry = (dynamic parsedGeometry, dynamic scene) => {
var id = parsedGeometry.id;
return scene.getGeometryByID(id);
}
;
var parseBox = (dynamic parsedBox, dynamic scene) => {
...
;
var parseSphere = (dynamic parsedSphere, dynamic scene) => {
...
;
var parseCylinder = (dynamic parsedCylinder, dynamic scene) => {
...
;
var parseTorus = (dynamic parsedTorus, dynamic scene) => {
...
;
var parseGround = (dynamic parsedGround, dynamic scene) => {
...
;
var parsePlane = (dynamic parsedPlane, dynamic scene) => {
...
;
var parseTorusKnot = (dynamic parsedTorusKnot, dynamic scene) => {
...
;
var parseVertexData = (dynamic parsedVertexData, dynamic scene, dynamic rootUrl) => {
...
;
var parseMesh = (dynamic parsedMesh, dynamic scene, dynamic rootUrl) => {
...
mesh.setPhysicsState(new dynamic());
}
...
;
var isDescendantOf = (dynamic mesh, dynamic names, dynamic hierarchyIds) => {
names=((namesisArray)) ? names : new Array<object>();
...
;
var importVertexData = (dynamic parsedVertexData, dynamic geometry) => {
...
;
var importGeometry = (dynamic parsedGeometry, dynamic mesh) => {
...
;
BABYLON.SceneLoader.RegisterPlugin(new dynamic());
...
public virtual string[] getAttributesNames() {
...
public virtual string[] getSamplers() {
return this._samplers;
}
public virtual string getCompilationException() {
return this._compilationException;
}
public virtual void _loadVertexShader(object vertex, Func<object, object> callback) {
...
public virtual void _loadFragmentShader(object fragment, Func<object, object> callback) {
...
public virtual void _prepareEffect(string vertexSourceCode, string fragmentSourceCode, string[] attributesNames, string defines, string[] optionalDefines, bool useFallback) {
try{
...
{
this._valueCache[uniformName]=new Array<object>();
return;
}
...
public virtual Effect setArray(string uniformName, float[] array) {
...
public static dynamic ShadersStore=new dynamic();
}
}
